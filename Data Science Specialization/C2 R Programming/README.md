...
<table style="width:100%">
  ...
  <tr>
    <td colspan = "3">
      ...
      A number of custom R function which are able to cache the mean of a vector and the inverse of a matrix.
...
<table style="width:100%">
  ...
  <tr>
    <td colspan = "3">
      ...
      Generated statistical inferences and summary plots related to comparable hospital performance over the US.
