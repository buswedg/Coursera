<table style="width:100%">
  ...
  <tr>
    <td colspan = "3">
      ...
      R markdown document which describes data collected from a monitoring device (number of steps taken) worn by an anonymous individual.
...
<table style="width:100%">
  ...
  <tr>
    <td colspan = "3">
      ...
      R markdown document which describes data collected from the National Oceanic and Atmospheric Administration (NOAA).
