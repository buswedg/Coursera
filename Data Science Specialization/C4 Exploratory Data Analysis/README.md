<table style="width:100%">
  ...
  <tr>
    <td colspan = "3">
      ...
      Applied basic data wrangling and created a number of plots to represent household power consumption data.
...
<table style="width:100%">
  ...
  <tr>
    <td colspan = "3">
      ...
      Applied basic data wrangling and created a number of plots to represent particulate matter (PM2.5) air pollutant data for the US.
