...
<td>
Data Applications<br>Exploratory Analysis<br>Machine Learning<br>Statistical Inference
</td>
<td>
R/R-Studio<br>Shiny
</td>
<td>
Energy<br>Environment<br>Health Care<br>Healthcare<br>Information Technology<br>Transportation
</td>
</tr>
<tr>
...
<tr>
<td colspan="4">
<p>Concepts and tools needed throughout the entire data science pipeline, from asking the right kinds of questions to making inferences and publishing results.</p>
<p>Includes:</p>
<ul>
...
<p>Includes:</p>
<ul>
<li>A number of basic interactive applications (games) built using Python, including 'Rock-Paper-Scissors-Lizard-Spock', 'Guess the Number' and 'Stopwatch: The Game', and 'Pong'.<br><br>
Includes:<br>
...
<li>A number of basic/intermediate interactive applications (games) built using Python, including 'Memory', 'Blackjack', and 'Spacerocks'.<br><br>
Includes:<br>
<ul style = "list-style-type:square;font-size:13px">
...
<li>A number of intermediate interactive applications (games) built using Python, including 'Solitaire Mancala', '2048', and 'Tic-Tac-Toe'.<br><br>
Includes:<br>
<ul style = "list-style-type:square;font-size:13px">
...
<td>
Education<br>Environment<br>Food, Beverages and Tobacco<br>Housing<br>Information Technology<br>Manufacturing
</td>
</tr>
<tr>
<td colspan="4"><b>Description</b></td>
